	...
	*******************************************************************************/
	...
	SELECT  MAX(AllocationRulesStageId) AS AllocationRulesStageId
		 , AllocationGroup,AllocationCode,StepCode,BatchID,AllocationUser,UserID,GranularityFlag
	...
	GROUP BY AllocationGroup,AllocationCode,StepCode,BatchID,AllocationUser,UserID,GranularityFlag
		, AccountDest,TrifocusDest,EntityDest,LocationDest,ProjectDest,YOADest,ProcessDest,TargetPeriodDest,TargetEntityDest,TargetCurrencyDest
		, AccountFrom,AccountTo,TrifocusFrom,TrifocusTo,EntityFrom,EntityTo,LocationFrom,LocationTo,ProjectFrom,ProjectTo
		, YOAFrom,YOATo,ProcessFrom,ProcessTo,TargetEntityFrom,TargetEntityTo
	...
	*******************************************************************************/
	...
	SELECT A.AllocationRulesStageId,B.PK_AllocationRules,A.AllocationGroup,A.AllocationCode,A.StepCode,A.BatchID,A.AllocationUser,A.UserID,A.GranularityFlag
	...
	*******************************************************************************/
	INSERT INTO #AllocationRulesTemp(AllocationRulesStageId,PK_AllocationRules,A.AllocationGroup,AllocationCode,StepCode,BatchID,AllocationUser,UserID,GranularityFlag
				, AccountDest,TrifocusDest,EntityDest,LocationDest,ProjectDest,YOADest,ProcessDest,TargetPeriodDest,TargetEntityDest,TargetCurrencyDest
				, AccountFrom,AccountTo,TrifocusFrom,TrifocusTo,EntityFrom,EntityTo,LocationFrom,LocationTo,ProjectFrom,ProjectTo
				, YOAFrom,YOATo,ProcessFrom,ProcessTo,TargetEntityFrom,TargetEntityTo
	...
	SELECT A.AllocationRulesStageId,CAST(0 AS INT) AS PK_AllocationRules,A.AllocationGroup,A.AllocationCode,A.StepCode,A.BatchID,A.AllocationUser,A.UserID,A.GranularityFlag
		 , A.AccountDest,A.TrifocusDest,A.EntityDest,A.LocationDest,A.ProjectDest,A.YOADest,A.ProcessDest,A.TargetPeriodDest,A.TargetEntityDest,A.TargetCurrencyDest
		 , A.AccountFrom,A.AccountTo,A.TrifocusFrom,A.TrifocusTo,A.EntityFrom,A.EntityTo,A.LocationFrom,A.LocationTo,A.ProjectFrom,A.ProjectTo
		 , A.YOAFrom,A.YOATo,A.ProcessFrom,A.ProcessTo,A.TargetEntityFrom,A.TargetEntityTo
	...
	*******************************************************************************/
	INSERT INTO #AllocationRulesTemp(AllocationRulesStageId,PK_AllocationRules,AllocationGroup,AllocationCode,StepCode,BatchID,AllocationUser,A.UserID,GranularityFlag
				, AccountDest,TrifocusDest,EntityDest,LocationDest,ProjectDest,YOADest,ProcessDest,TargetPeriodDest,TargetEntityDest,TargetCurrencyDest
				, AccountFrom,AccountTo,TrifocusFrom,TrifocusTo,EntityFrom,EntityTo,LocationFrom,LocationTo,ProjectFrom,ProjectTo
				, YOAFrom,YOATo,ProcessFrom,ProcessTo,TargetEntityFrom,TargetEntityTo
				, AllocationGroupCodeVersion,AllocationGroupCodeSubVersion
	...
	*******************************************************************************/
	INSERT INTO #AllocationRulesTemp(AllocationRulesStageId,PK_AllocationRules,AllocationGroup,AllocationCode,StepCode,BatchID,AllocationUser,UserID,GranularityFlag
				, AccountDest,TrifocusDest,EntityDest,LocationDest,ProjectDest,YOADest,ProcessDest,TargetPeriodDest,TargetEntityDest,TargetCurrencyDest
				, AccountFrom,AccountTo,TrifocusFrom,TrifocusTo,EntityFrom,EntityTo,LocationFrom,LocationTo,ProjectFrom,ProjectTo
				, YOAFrom,YOATo,ProcessFrom,ProcessTo,TargetEntityFrom,TargetEntityTo
				, AllocationGroupCodeVersion,AllocationGroupCodeSubVersion
				, AllocationPercent,ChangeType)
	SELECT 0 AS AllocationRulesStageId,B.PK_AllocationRules,B.AllocationGroup,B.AllocationCode,B.StepCode,B.BatchID,B.AllocationUser,B.UserID,B.GranularityFlag
	...
	*******************************************************************************/
	...
	--SELECT * FROM #AllocationRulesTemp WHERE ChangeType = 'New'
	--SELECT * FROM staging_agresso.dbo.AllocationRulesStage_POC WHERE AllocationRulesStageId IN (89,90,131,132,129,130,91,92)
	...
	*/
	...
	DECLARE @AllocationGroupId INT

	SELECT @AllocationGroupId = ISNULL(MAX(AllocationGroupId),0) + 1 FROM dbo.DimAllocationRules_POC WHERE AllocationGroup = @AllocationGroup

	--SELECT @AllocationGroupId

	--SELECT TOP 2 * FROM #AllocationRulesTemp ORDER BY ChangeType
	--SELECT TOP 2 * FROM [staging_agresso].dbo.AllocationRulesStage
	--SELECT TOP 2 * FROM dbo.DimAllocationRules_POC WHERE AllocationGroup = @AllocationGroup

	--SELECT ISNULL(AllocationGroupCodeSubVersion,0) + 1,* 
	UPDATE #AllocationRulesTemp
	   SET AllocationGroupCodeSubVersion =  1
	 WHERE ChangeType = 'New'

	--SELECT * FROM 
	UPDATE #AllocationRulesTemp
	   SET AllocationGroupCodeSubVersion =  ISNULL(AllocationGroupCodeSubVersion,0) + 1 
	 WHERE ChangeType = 'Meta Data Change'
	/*
	SELECT * FROM #AllocationRulesTemp WHERE ChangeType = 'New'
	SELECT * FROM #AllocationRulesTemp WHERE ChangeType = 'Meta Data Change'
	SELECT * FROM #AllocationRulesTemp WHERE ChangeType = 'No Change'
	SELECT * FROM #AllocationRulesTemp WHERE ChangeType = 'Deleted'
	*/